...
{
	class AFortPawn*                                   InPawn;                                                   // (Parm, ZeroConstructor, IsPlainOldData)
...
{
	class AFortAIPawn*                                 InPawn;                                                   // (Parm, ZeroConstructor, IsPlainOldData)
...
struct UGA_Constructor_BullRush_C_ApplyDamageToTarget_Params
{
	...
	class UClass*                                      Applied;                                                  // (Parm, ZeroConstructor, IsPlainOldData)
};
...
{
	class AFortPawn*                                   Actor;                                                    // (Parm, ZeroConstructor, IsPlainOldData)
	bool                                               ReturnValue;                                              // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};
...
{
	class AFortAIPawn*                                 InputPin;                                                 // (Parm, ZeroConstructor, IsPlainOldData)
	bool                                               ApplyDamage;                                              // (Parm, ZeroConstructor, IsPlainOldData)
};
...
{
	TScriptInterface<class UGameplayTagAssetInterface> InPawn;                                                   // (Parm, ZeroConstructor, IsPlainOldData)
...
{
	class ABuildingActor*                              InActor;                                                  // (Parm, ZeroConstructor, IsPlainOldData)
...
{
	class AActor*                                      InOverlap;                                                // (Parm, ZeroConstructor, IsPlainOldData)
...
{
	bool                                               bEnableSteeringReduction;                                 // (Parm, ZeroConstructor, IsPlainOldData)
};
...
{
	float                                              InDelta;                                                  // (Parm, ZeroConstructor, IsPlainOldData)
};
...
{
	class AFortPawn*                                   InOverlapped;                                             // (Parm, ZeroConstructor, IsPlainOldData)
};
...
{
	class AFortAIPawn*                                 LocalOverlap;                                             // (Parm, ZeroConstructor, IsPlainOldData)
};
