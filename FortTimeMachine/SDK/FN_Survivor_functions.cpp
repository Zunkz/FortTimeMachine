...
// (Public, BlueprintCallable, BlueprintEvent)
// Parameters:
// TEnumAsByte<ESurvivorHitInfoType> SurvivorHitInfoType            (Parm, ZeroConstructor, IsPlainOldData)
...
// (Public, BlueprintCallable, BlueprintEvent)
// Parameters:
// bool                           ShouldInteractChannelBeActive  (Parm, ZeroConstructor, IsPlainOldData)
...
// (BlueprintCallable, BlueprintEvent)
// Parameters:
// bool                           LockedInPlace                  (Parm, ZeroConstructor, IsPlainOldData)
...
// (BlueprintCallable, BlueprintEvent)
// Parameters:
// class AFortAIPawn*             DownedAI                       (Parm, ZeroConstructor, IsPlainOldData)
// class AController*             DownedInstigator               (Parm, ZeroConstructor, IsPlainOldData)
