...
struct AOB_Special_Mine_Door_C_UserConstructionScript_Params
{
};

// Function OB_Special_Mine_Door.OB_Special_Mine_Door_C.ReceiveDestroyed
struct AOB_Special_Mine_Door_C_ReceiveDestroyed_Params
{
};

// Function OB_Special_Mine_Door.OB_Special_Mine_Door_C.OnDamageServer
struct AOB_Special_Mine_Door_C_OnDamageServer_Params
{
...
struct AOB_Special_Mine_Door_C_OnDeathServer_Params
{
	float*                                             Damage;                                                   // (Parm, ZeroConstructor, IsPlainOldData)
	struct FGameplayTagContainer*                      DamageTags;                                               // (ConstParm, Parm, OutParm, ReferenceParm)
	struct FVector*                                    Momentum;                                                 // (Parm, IsPlainOldData)
...
struct AOB_Special_Mine_Door_C_ExecuteUbergraph_OB_Special_Mine_Door_Params
{
