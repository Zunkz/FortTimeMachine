...
void AOB_Special_Mine_wall_C::UserConstructionScript()
{
	static auto fn = UObject::FindObject<UFunction>("Function OB_Special_Mine_wall.OB_Special_Mine_wall_C.UserConstructionScript");

	AOB_Special_Mine_wall_C_UserConstructionScript_Params params;
...
void AOB_Special_Mine_wall_C::OnDamageServer(float* Damage, struct FGameplayTagContainer* DamageTags, struct FVector* Momentum, struct FHitResult* HitInfo, class AController** InstigatedBy, class AActor** DamageCauser, struct FGameplayEffectContextHandle* EffectContext)
{
	static auto fn = UObject::FindObject<UFunction>("Function OB_Special_Mine_wall.OB_Special_Mine_wall_C.OnDamageServer");

	AOB_Special_Mine_wall_C_OnDamageServer_Params params;
...
void AOB_Special_Mine_wall_C::HandleMissionEvent_HuskHasBeenKilled(const struct FGuid& MissionGuid, const struct FGameplayTagContainer& ObjectiveHandle, class UFortMissionEventParams* Params, bool DO_NOT_USE_THIS_OR_VARIABLES_BELOW, class UObject* EventFocus, class UDataAsset* EventContent, class AActor* EventInstigator, int GenericInt, float GenericFloat, const struct FText& GenericText, const struct FGameplayTagContainer& GameplayTags, const struct FFortMissionEvent& MissionEvent)
{
	static auto fn = UObject::FindObject<UFunction>("Function OB_Special_Mine_wall.OB_Special_Mine_wall_C.HandleMissionEvent_HuskHasBeenKilled");

	AOB_Special_Mine_wall_C_HandleMissionEvent_HuskHasBeenKilled_Params params;
...
void AOB_Special_Mine_wall_C::ExecuteUbergraph_OB_Special_Mine_wall(int EntryPoint)
{
	static auto fn = UObject::FindObject<UFunction>("Function OB_Special_Mine_wall.OB_Special_Mine_wall_C.ExecuteUbergraph_OB_Special_Mine_wall");

	AOB_Special_Mine_wall_C_ExecuteUbergraph_OB_Special_Mine_wall_Params params;
