...
struct ABP_MinimapHighlight_Cars_C_HandleMissionEvent_OBJ_3_Complete_Params
{
	struct FGuid                                       MissionGuid;                                              // (Parm, IsPlainOldData)
	struct FGameplayTagContainer                       ObjectiveHandle;                                          // (Parm)
	class UFortMissionEventParams*                     Params;                                                   // (Parm, ZeroConstructor, IsPlainOldData)
...
struct ABP_MinimapHighlight_Cars_C_Input_Params
{
...
struct ABP_MinimapHighlight_Cars_C_Died_Params
{
...
struct ABP_MinimapHighlight_Cars_C_StartHints_Params
{
};

// Function BP_MinimapHighlight_Cars.BP_MinimapHighlight_Cars_C.timeup
struct ABP_MinimapHighlight_Cars_C_timeup_Params
{
};

// Function BP_MinimapHighlight_Cars.BP_MinimapHighlight_Cars_C.OnDeathServer
struct ABP_MinimapHighlight_Cars_C_OnDeathServer_Params
{
	float*                                             Damage;                                                   // (Parm, ZeroConstructor, IsPlainOldData)
...
struct ABP_MinimapHighlight_Cars_C_nukeeffects_Params
{
};

// Function BP_MinimapHighlight_Cars.BP_MinimapHighlight_Cars_C.finalreminder
struct ABP_MinimapHighlight_Cars_C_finalreminder_Params
{
};

// Function BP_MinimapHighlight_Cars.BP_MinimapHighlight_Cars_C.ExecuteUbergraph_BP_MinimapHighlight_Cars
struct ABP_MinimapHighlight_Cars_C_ExecuteUbergraph_BP_MinimapHighlight_Cars_Params
{
