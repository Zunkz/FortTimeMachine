...
struct AOB_Tree_Special_04_C_UserConstructionScript_Params
{
};

// Function OB_Tree_Special_04.OB_Tree_Special_04_C.OnDamagePlayEffects
struct AOB_Tree_Special_04_C_OnDamagePlayEffects_Params
{
...
struct AOB_Tree_Special_04_C_ReceiveBeginPlay_Params
{
};

// Function OB_Tree_Special_04.OB_Tree_Special_04_C.OnDeathServer
struct AOB_Tree_Special_04_C_OnDeathServer_Params
{
	float*                                             Damage;                                                   // (Parm, ZeroConstructor, IsPlainOldData)
	struct FGameplayTagContainer*                      DamageTags;                                               // (ConstParm, Parm, OutParm, ReferenceParm)
	struct FVector*                                    Momentum;                                                 // (Parm, IsPlainOldData)
...
struct AOB_Tree_Special_04_C_ExecuteUbergraph_OB_Tree_Special_04_Params
{
